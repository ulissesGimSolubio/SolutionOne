...
namespace Ecomerce.Data.Migrations
{
    ...
    [Migration("20240424032233_EnderecoCliente_v4")]
    partial class EnderecoCliente_v4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecomerce.Models.Cidade", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(7381))
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(7810))
            ...
            modelBuilder.Entity("Ecomerce.Models.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 678, DateTimeKind.Local).AddTicks(2116))
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 678, DateTimeKind.Local).AddTicks(2645))
            ...
            modelBuilder.Entity("Ecomerce.Models.Endereco", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 679, DateTimeKind.Local).AddTicks(2030))
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 679, DateTimeKind.Local).AddTicks(2500))
            ...
            modelBuilder.Entity("Ecomerce.Models.Estado", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(3337))
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(3806))
            ...
            modelBuilder.Entity("Ecomerce.Models.Pais", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(844))
                    ...
                    b.Property<DateTime>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 0, 22, 32, 677, DateTimeKind.Local).AddTicks(1310))
